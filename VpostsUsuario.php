...
<div class="container my-3">
    <div class="row justify-content-center my-2">
        <?php 
        $queryPost = "SELECT * FROM post p, usuarios u, autores a WHERE p.id_autor = a.id AND a.id_usuario = u.id AND u.usuario = '$varUsuario'";
        ...
        <div class="col-md-4">
            ...
            <a class="btn btn-outline-danger btn-block" href="#"> Editar </a>
        </div>
        <?php }?>
    </div>
</div>
